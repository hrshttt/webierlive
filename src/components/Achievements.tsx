    ...
    () => {
      ...
      gsap.fromTo(
        ...
        { y: 40, opacity: 0 },
        {
          ...
          opacity: 1,
          duration: 0.5,
          stagger: 0.1, // Slight delay between each card
          ease: "power2.out",
          scrollTrigger: {
            trigger: ".bento-grid",
            start: "top bottom", // Starts as soon as the grid enters the viewport
    ...
    >
      ...
      <div className="relative z-10 mb-8">
        <div className="flex items-baseline">
          <span
            ref={numberRef}
            className={`font-display font-black tracking-tighter text-[#1a1a1a] leading-[0.9] group-hover:text-[#3533cd] transition-colors duration-300 ${
              stat.type === "primary"
          ...
          <span
            className={`font-display font-thin text-[#1a1a1a]/40 ml-1 ${
              stat.type === "primary"
